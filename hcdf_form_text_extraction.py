...
class ocr_extraction:
    def __init__(self):
        self.subscription_key = 'baa5db3a8ccf41158562b7aabffb4f7d'  # 'd7d1fec58933440fa89fcfd8f9b58a06'
        self.endpoint = "https://ocr-extraction.cognitiveservices.azure.com/"  # 'https://hcdf-ocr.cognitiveservices.azure.com/'#'https://hcdf-form.cognitiveservices.azure.com/'
...
if __name__ == "__main__":
    ...
    data = requests.get(
        'https://imagecleaningpreprocesso.blob.core.windows.net/sendtoaiapiblob/9053507b-f038-4d4f-bbf1-75c6354a4018')
